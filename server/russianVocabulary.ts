...
export const russianVocabulary: VocabularyWord[] = [
  ...
  { russian: "лошадь", english: "horse", category: "animals", frequencyRank: 5 },
  { russian: "корова", english: "cow", category: "animals", frequencyRank: 6 },
  { russian: "свинья", english: "pig", category: "animals", frequencyRank: 7 },
  { russian: "курица", english: "chicken", category: "animals", frequencyRank: 8 },
  { russian: "мышь", english: "mouse", category: "animals", frequencyRank: 9 },
  { russian: "медведь", english: "bear", category: "animals", frequencyRank: 10 },
  
  // Family (Семья)
  { russian: "мама", english: "mom", category: "family", frequencyRank: 11 },
  { russian: "папа", english: "dad", category: "family", frequencyRank: 12 },
  { russian: "брат", english: "brother", category: "family", frequencyRank: 13 },
  { russian: "сестра", english: "sister", category: "family", frequencyRank: 14 },
  { russian: "бабушка", english: "grandma", category: "family", frequencyRank: 15 },
  { russian: "дедушка", english: "grandpa", category: "family", frequencyRank: 16 },
  { russian: "друг", english: "friend", category: "family", frequencyRank: 17 },
  { russian: "ребёнок", english: "child", category: "family", frequencyRank: 18 },
  ...
  { russian: "зелёный", english: "green", category: "colors", frequencyRank: 31 },
  { russian: "жёлтый", english: "yellow", category: "colors", frequencyRank: 32 },
  { russian: "белый", english: "white", category: "colors", frequencyRank: 33 },
  { russian: "чёрный", english: "black", category: "colors", frequencyRank: 34 },
  { russian: "оранжевый", english: "orange", category: "colors", frequencyRank: 35 },
  { russian: "розовый", english: "pink", category: "colors", frequencyRank: 36 },
  ...
  { russian: "четыре", english: "four", category: "numbers", frequencyRank: 40 },
  ...
  { russian: "восемь", english: "eight", category: "numbers", frequencyRank: 44 },
  { russian: "девять", english: "nine", category: "numbers", frequencyRank: 45 },
  ...
  { russian: "цветок", english: "flower", category: "nature", frequencyRank: 51 },
  ...
  // Actions (Действия)
  { russian: "есть", english: "to eat", category: "actions", frequencyRank: 71 },
  { russian: "пить", english: "to drink", category: "actions", frequencyRank: 72 },
  { russian: "спать", english: "to sleep", category: "actions", frequencyRank: 73 },
  { russian: "играть", english: "to play", category: "actions", frequencyRank: 74 },
  { russian: "бегать", english: "to run", category: "actions", frequencyRank: 75 },
  { russian: "прыгать", english: "to jump", category: "actions", frequencyRank: 76 },
  { russian: "читать", english: "to read", category: "actions", frequencyRank: 77 },
  { russian: "писать", english: "to write", category: "actions", frequencyRank: 78 },
  ...
  { russian: "привет", english: "hello", category: "common", frequencyRank: 81 },
  { russian: "пока", english: "bye", category: "common", frequencyRank: 82 },
  { russian: "спасибо", english: "thank you", category: "common", frequencyRank: 83 },
  { russian: "пожалуйста", english: "please", category: "common", frequencyRank: 84 },
  ...
  { russian: "маленький", english: "small", category: "common", frequencyRank: 88 },
  
  // Transport (Транспорт)
  { russian: "машина", english: "car", category: "transport", frequencyRank: 89 },
  { russian: "автобус", english: "bus", category: "transport", frequencyRank: 90 },
  { russian: "поезд", english: "train", category: "transport", frequencyRank: 91 },
  { russian: "самолёт", english: "airplane", category: "transport", frequencyRank: 92 },
  { russian: "велосипед", english: "bicycle", category: "transport", frequencyRank: 93 },
  { russian: "корабль", english: "ship", category: "transport", frequencyRank: 94 },
  ...
  { russian: "завтра", english: "tomorrow", category: "time", frequencyRank: 100 },
];
